...
class _ChatConversationScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final hasQueued =
        messages.any((m) => m.isMine && m.status == MessageStatus.queued);
    final peerData = ref.watch(survivorProvider);
    final peerStatus = peerData[widget.nodeId] ??
        SurvivorNodeModel(id: widget.nodeId, status: 'unknown', lastSeen: 0);
    final isOnline = !peerStatus.isOffline &&
        peerStatus.lastSeen > DateTime.now().millisecondsSinceEpoch - 120000;
        ...
        leading: Container(
          ...
          child: IconButton(
              icon: Icon(Icons.arrow_back,
                  color: AegisColors.textPrimary, size: 20),
              onPressed: () => Navigator.of(context).pop()),
        ),
        title: Row(children: [
          Builder(builder: (context) {
            final peerNode = ref.read(survivorProvider)[widget.nodeId];
            final peerImageBase64 = peerNode?.profileImageBase64;
            if (peerImageBase64 != null) {
              return CircleAvatar(
                radius: 18,
                backgroundImage: MemoryImage(base64Decode(peerImageBase64)),
              );
            }
            return Container(
              width: 36,
              ...
              decoration: BoxDecoration(
                gradient: isOnline
                    ? AegisColors.greenGradient
                    : LinearGradient(
                        colors: [AegisColors.textMuted, AegisColors.textDim]),
                shape: BoxShape.circle,
                boxShadow: isOnline
                    ? [
                        BoxShadow(
          ...
          Container(
            ...
            child: PopupMenuButton<String>(
              ...
              itemBuilder: (_) => [
                PopupMenuItem(
                    value: 'info',
                    child: Text('Peer Info',
                        style: TextStyle(color: AegisColors.textPrimary))),
                PopupMenuItem(
                    value: 'clear',
                    child: Text('Clear Chat',
                        style: TextStyle(color: AegisColors.sosRed))),
              ],
            ),
          ),
        ],
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.chat_bubble_outline_rounded,
                              size: 48, color: AegisColors.textMuted),
                          SizedBox(height: 16),
                          ...
                          Text('Send a message to start the conversation',
                              style: TextStyle(
                                  color: AegisColors.textDim, fontSize: 13)),
                        ],
                      ),
                    )
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          _buildMessageItems(messages)[index],
                    ),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          shape: BoxShape.circle,
                          border: Border.all(
                              color: AegisColors.border1, width: 0.5),
                          boxShadow: [
                            BoxShadow(color: Colors.black26, blurRadius: 8)
                          ]),
                      child: Icon(Icons.keyboard_arrow_down_rounded,
                          color: AegisColors.textPrimary, size: 22),
                    ),
                  ),
                ),
            ]),
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AegisColors.border1.withValues(alpha: 0.3),
                  width: 0.5)),
            ...
            : Container(
                ...
                decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [
                      ...
                      AegisColors.violet.withValues(alpha: 0.1)
                    ]),
                    shape: BoxShape.circle),
                child: const Center(
                    child: Icon(Icons.person_rounded,
                        size: 14, color: AegisColors.violet)),
              ),
        SizedBox(width: 8),
        Flexible(
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: AegisColors.isLight
                      ...
                      : AegisColors.surface2,
                  borderRadius: const BorderRadius.only(
                      topRight: Radius.circular(20),
                      bottomLeft: Radius.circular(4),
                      bottomRight: Radius.circular(20)),
                  border: Border.all(
                      color: AegisColors.border1.withValues(alpha: 0.2),
                      width: 0.5)),
              child: Column(
                  ...
                  children: [
                    ...
                    Align(
                        ...
                        child: Text(time,
                            style: AegisStyles.timestamp.copyWith(
  ...
  Widget _outgoing(ChatEntry entry, String time) {
    ...
    final isSent = entry.status == MessageStatus.sent ||
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: AegisColors.isLight
                            ...
                            : AegisColors.neonGreen.withValues(alpha: 0.15),
                        width: 0.5),
                  ),
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      ...
                      children: [
                        Text(entry.text,
                            style: AegisStyles.message.copyWith(
                                color: AegisColors.isLight
            ...
            Flexible(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: AegisColors.isLight
                          ? AegisColors.warning.withValues(alpha: 0.08)
                      ...
                      borderRadius: const BorderRadius.only(
                          ...
                          bottomRight: Radius.circular(4)),
                      border: Border.all(
                          color: AegisColors.warning.withValues(alpha: 0.3),
                          width: 0.5)),
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        ...
                        Row(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          Icon(Icons.access_time_rounded,
                              color: AegisColors.warning, size: 11),
                        ]),
                        SizedBox(height: 2),
                        Text('Queued',
                            style: TextStyle(
  ...
  Widget _offlineBanner() {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              color: AegisColors.warning.withValues(alpha: 0.25), width: 0.5)),
      child: Row(children: [
        Container(
            width: 36,
            height: 36,
            ...
            child: Column(
              ...
              Text('Queued Message',
                  style: TextStyle(
                      ...
                      fontSize: 13)),
              SizedBox(height: 2),
              Text('Will deliver when ${widget.nodeId} comes back online.',
                  style: TextStyle(
                      color: AegisColors.textSecondary, fontSize: 11)),
            ])),
      ]),
    );
  }
  ...
  Widget _input() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
            top: BorderSide(
                color: AegisColors.border1.withValues(alpha: 0.2), width: 0.5)),
      ),
      child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: AegisColors.border1.withValues(alpha: 0.4),
                    width: 0.5)),
            ...
            child: Row(children: [
              Expanded(
                ...
                decoration: InputDecoration(
                    ...
                    hintStyle:
                        TextStyle(color: AegisColors.textMuted, fontSize: 15),
              ...
              GestureDetector(
                ...
                child: Container(
                    ...
                    child: Icon(Icons.attach_file_rounded,
                        color: AegisColors.textMuted, size: 18)),
              ),
            ]),
          ),
        ),
    ...
    return Container(
      ...
      child: SafeArea(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(height: 20),
          _sheetOpt(
              Icons.file_present_rounded, 'Share File', AegisColors.textDim,
              () {
          ...
          SizedBox(height: 4),
          _sheetOpt(
              Icons.mic_none_rounded, 'Voice Message', AegisColors.textDim, () {
            Navigator.of(context).pop();
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            gradient: LinearGradient(
                ...
                colors: [
              Colors.transparent,
              AegisColors.border1.withValues(alpha: 0.3),
              Colors.transparent
            ])));
  }
}
